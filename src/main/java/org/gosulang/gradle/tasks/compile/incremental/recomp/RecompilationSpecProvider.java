 ...
 * Second, initialize the recompilation (e.g. delete stale class files and narrow down the source files to be recompiled): {@link #initializeCompilation(GosuCompileSpec, RecompilationSpec)}
...
public interface RecompilationSpecProvider {
    ...
    void initializeCompilation(GosuCompileSpec spec, RecompilationSpec recompilationSpec);
