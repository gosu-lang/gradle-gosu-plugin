...
import org.gosulang.gradle.tasks.compile.incremental.classpath.DefaultClasspathEntrySnapshotter;
...
public class PreviousCompilationOutputAnalyzer {
  private static final Logger LOG = LoggerFactory.getLogger(org.gradle.api.internal.tasks.compile.incremental.recomp.PreviousCompilationOutputAnalyzer.class);
  ...
  public ClassSetAnalysis getAnalysis(File classesDirectory) {
    ...
    // TODO: make sure this is actually producting compatible data?
