...
public class ClasspathEntrySnapshotDataSerializer extends AbstractSerializer<ClasspathEntrySnapshotData> {
  ...
  public boolean equals(Object obj) {
    ...
    return equal(mapSerializer, rhs.mapSerializer)
        && equal(analysisSerializer, rhs.analysisSerializer)
        && equal(hashCodeSerializer, rhs.hashCodeSerializer);
  }
  ...
  @Override
  public int hashCode() {
    return hashCode(super.hashCode(), mapSerializer, analysisSerializer, hashCodeSerializer);
  }
